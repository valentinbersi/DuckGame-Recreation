        ...
        WeaponFactory::factory = {
                ...
                {ItemID::CowboyPistol,
                 [] {
                     return std::make_unique<LongPistol>(
                            ItemID::CowboyPistol,
                            Config::Weapons::CowboyPistol::ammo(),
                ...
                {ItemID::Magnum,
                 [] {
                     return std::make_unique<LongPistol>(
                            ItemID::Magnum, 
                            Config::Weapons::Magnum::ammo(),
                            Config::Weapons::Magnum::recoil(), 
                ...
                {ItemID::Sniper, [] {
                 ...
                 {ItemID::Ak47, [] {
                     return std::make_unique<Ak47>(
                             ItemID::Ak47, 
                             Config::Weapons::Ak47::ammo(),
                             Config::Weapons::Ak47::recoil(), 
